...
new GLTFLoader().load('3d/concept_ferrari.glb', (gltf) => {
    ...
    mesh.traverse((child) => {
        if (child.isMesh) {
            ...
            const isWheel = ['Object_200', 'Object_203', 'Object_206', 'Object_208', 'Object_210', 'Object_212', 'Object_216', 'Object_218', 'Object_220', 'Object_222', 'Object_225', 'Object_227',
                'Object_95', 'Object_98', 'Object_101', 'Object_103', 'Object_105', 'Object_107', 'Object_111', 'Object_113', 'Object_115', 'Object_117', 'Object_120', 'Object_122',
                'Object_51', 'Object_54', 'Object_57', 'Object_59', 'Object_61', 'Object_63', 'Object_67', 'Object_69', 'Object_71', 'Object_73', 'Object_76', 'Object_78',
                'Object_148', 'Object_151', 'Object_154', 'Object_156', 'Object_158', 'Object_160', 'Object_165', 'Object167', 'Object_169', 'Object_171', 'Object_173', 'Object_175'].includes(child.name);

            child.userData.isWheel = isWheel;

            //RR Wheel Objects
            if (['Object_200', 'Object_203', 'Object_206', 'Object_208', 'Object_210', 'Object_212', 'Object_216', 'Object_218', 'Object_220', 'Object_222', 'Object_225', 'Object_227'].includes(child.name)) {
                ...
                pivot.add(child);
                child.position.set(0, 1.90, 0.28);
                wheels.push(pivot);
            }

            //LR Wheel Objects
            if (['Object_95', 'Object_98', 'Object_101', 'Object_103', 'Object_105', 'Object_107', 'Object_111', 'Object_113', 'Object_115', 'Object_117', 'Object_120', 'Object_122'].includes(child.name)) {
                const pivot = new THREE.Group();
                const wheelParent = child.parent;
            ...
            //RF Wheel Objects
            if (['Object_51', 'Object_54', 'Object_57', 'Object_59', 'Object_61', 'Object_63', 'Object_67', 'Object_69', 'Object_71', 'Object_73', 'Object_76', 'Object_78'].includes(child.name)) {
                const pivot = new THREE.Group();
                const wheelParent = child.parent;
            ...
            //LF Wheel Objects
            if (['Object_148', 'Object_151', 'Object_154', 'Object_156', 'Object_158', 'Object_160', 'Object_165', 'Object167', 'Object_169', 'Object_171', 'Object_173', 'Object_175'].includes(child.name)) {
                const pivot = new THREE.Group();
                const wheelParent = child.parent;
